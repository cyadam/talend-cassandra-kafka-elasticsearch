...
// Consumer configuration
				...
				tKafkaInput_1_kafkaProperties.put("group.id", context.cassandra_group);
...
// Single-threaded consumer. Make sure the new security information is picked up.
				...
				tKafkaInput_1_kafkaConsumer.subscribe(java.util.Arrays.asList(context.topic));
...
// Start of branch "row2"
									if (row2 != null) {
										...
										strTemp_tWriteJSONField_1_Out = strTemp_tWriteJSONField_1_Out
												...
												+ valueMap_tWriteJSONField_1_Out.get("theme").length();
										strTemp_tWriteJSONField_1_Out = strTemp_tWriteJSONField_1_Out
										...
										if (strCompCache_tWriteJSONField_1_Out == null) {
											...
											rowStructOutput_tWriteJSONField_1_Out.theme = row2.theme;
											...
											if (!strCompCache_tWriteJSONField_1_Out
												...
												row_tWriteJSONField_1_Out.indice = rowStructOutput_tWriteJSONField_1_Out.theme;
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				while (!globalMap.containsKey(readFinishMarkWithPipeId_tWriteJSONField_1_In)
					...
					if (!queue_tWriteJSONField_1_In.isEmpty()) {
						...
						row3.indice = result_tWriteJSONField_1_In.indice;
						...
						IndexRequest one = new IndexRequest(row3.indice).id(row3.id)
...
/************************************************************************************************
 * 172727 characters generated by Talend Open Studio for Big Data on the
 * September 10, 2019 at 9:28:34 AM UTC
 ************************************************************************************************/