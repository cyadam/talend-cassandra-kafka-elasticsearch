...
package debat_national.kafka2elasticsearch_1_0;
...
/**
 * Job: kafka2elasticsearch Purpose: <br>
 * Description: <br>
 * 
 ...
 * @status
 */
public class kafka2elasticsearch implements TalendJob {
	...
	public class ContextProperties extends PropertiesWithType {
		...
		public void synchronizeContext() {
			...
			if (elasticsearch_port != null) {
				...
				this.setProperty("elasticsearch_port", elasticsearch_port.toString());
			...
			if (group_elasticsearch != null) {

				this.setProperty("group_elasticsearch", group_elasticsearch.toString());

			}

			if (indice != null) {

				this.setProperty("indice", indice.toString());
		...
		public Integer elasticsearch_port;

		public Integer getElasticsearch_port() {
			return this.elasticsearch_port;
		}
		...
		public String group_elasticsearch;

		public String getGroup_elasticsearch() {
			return this.group_elasticsearch;
		}
	...
	private final String jobName = "kafka2elasticsearch";
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TDieException)) {
				if (e instanceof TalendException) {
					...
					kafka2elasticsearch.this.exception = e;
				}
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(kafka2elasticsearch.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
	...
	public static class row2Struct implements routines.system.IPersistableRow<row2Struct> {
		final static byte[] commonByteArrayLock_DEBAT_NATIONAL_kafka2elasticsearch = new byte[0];
		static byte[] commonByteArray_DEBAT_NATIONAL_kafka2elasticsearch = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_DEBAT_NATIONAL_kafka2elasticsearch.length) {
					if (length < 1024 && commonByteArray_DEBAT_NATIONAL_kafka2elasticsearch.length == 0) {
						commonByteArray_DEBAT_NATIONAL_kafka2elasticsearch = new byte[1024];
					} else {
						commonByteArray_DEBAT_NATIONAL_kafka2elasticsearch = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_DEBAT_NATIONAL_kafka2elasticsearch, 0, length);
				strReturn = new String(commonByteArray_DEBAT_NATIONAL_kafka2elasticsearch, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_DEBAT_NATIONAL_kafka2elasticsearch) {
...
//tWriteXMLFieldOut_begin
				...
				row2Struct rowStructOutput_tWriteJSONField_1_Out = new row2Struct();
...
// Consumer configuration
				...
				tKafkaInput_1_kafkaProperties.put("group.id", context.group_elasticsearch);
...
// Single-threaded consumer. Make sure the new security information is picked up.
				...
				tKafkaInput_1_kafkaConsumer.subscribe(java.util.Arrays.asList(context.topic_elasticsearch));
...
// Start consumption
				while (true) {
					try {
						// Use the provided consumer timeout and the consumer has to be stopped if there
						// is no record polled from the topic
						org.apache.kafka.clients.consumer.ConsumerRecords<byte[], row1Struct> tKafkaInput_1_consumerRecords = tKafkaInput_1_kafkaConsumer
								.poll(10000);
						// If there is no record polled from the topic, we know that we exceeded the
						// provided consumer timeout. So immediately stop processing.
						if (tKafkaInput_1_consumerRecords.isEmpty()) {
							break;
						}
...
// Start of branch "row2"
									if (row2 != null) {
										...
										valueMap_tWriteJSONField_1_Out.put("publishedAt",
												(row2.publishedAt != null
														? FormatterUtils.format_Date(row2.publishedAt,
																"yyyy-MM-dd HH:mm:ss")
														: null));
										...
										valueMap_tWriteJSONField_1_Out.put("updatedAt",
												(row2.updatedAt != null
														? FormatterUtils.format_Date(row2.updatedAt,
																"yyyy-MM-dd HH:mm:ss")
														: null));
										...
										valueMap_tWriteJSONField_1_Out.put(
												"Que_faudrait_il_faire_selon_vous_pour_apporter_des_reponses_a_ce_probleme__",
												(row2.Que_faudrait_il_faire_selon_vous_pour_apporter_des_reponses_a_ce_probleme__ != null
														? row2.Que_faudrait_il_faire_selon_vous_pour_apporter_des_reponses_a_ce_probleme__
																.toString()
														: null));
										arraysValueMap_tWriteJSONField_1_Out.put(
										...
										valueMap_tWriteJSONField_1_Out.put(
												"Diriez_vous_que_votre_vie_quotidienne_est_aujourd_hui_touchee_par_le_changement_climatique__",
												(row2.Diriez_vous_que_votre_vie_quotidienne_est_aujourd_hui_touchee_par_le_changement_climatique__ != null
														? row2.Diriez_vous_que_votre_vie_quotidienne_est_aujourd_hui_touchee_par_le_changement_climatique__
																.toString()
														: null));
										arraysValueMap_tWriteJSONField_1_Out.put(
										...
										valueMap_tWriteJSONField_1_Out.put(
												"Si_oui__de_quelle_maniere_votre_vie_quotidienne_est_elle_touchee_par_le_changement_climatique__",
												(row2.Si_oui__de_quelle_maniere_votre_vie_quotidienne_est_elle_touchee_par_le_changement_climatique__ != null
														? row2.Si_oui__de_quelle_maniere_votre_vie_quotidienne_est_elle_touchee_par_le_changement_climatique__
																.toString()
														: null));
										arraysValueMap_tWriteJSONField_1_Out.put(
										...
										valueMap_tWriteJSONField_1_Out.put(
												"A_titre_personnel__pensez_vous_pouvoir_contribuer_a_proteger_l_environnement__",
												(row2.A_titre_personnel__pensez_vous_pouvoir_contribuer_a_proteger_l_environnement__ != null
														? row2.A_titre_personnel__pensez_vous_pouvoir_contribuer_a_proteger_l_environnement__
																.toString()
														: null));
										arraysValueMap_tWriteJSONField_1_Out.put(
										...
										valueMap_tWriteJSONField_1_Out.put(
												"Si_oui__que_faites_vous_aujourd_hui_pour_proteger_l_environnement_et_ou_que_pourriez_vous_faire__",
												(row2.Si_oui__que_faites_vous_aujourd_hui_pour_proteger_l_environnement_et_ou_que_pourriez_vous_faire__ != null
														? row2.Si_oui__que_faites_vous_aujourd_hui_pour_proteger_l_environnement_et_ou_que_pourriez_vous_faire__
																.toString()
														: null));
										arraysValueMap_tWriteJSONField_1_Out.put(
										...
										valueMap_tWriteJSONField_1_Out.put(
												"Qu_est_ce_qui_pourrait_vous_inciter_a_changer_vos_comportements_comme_par_exemple_mieux_entretenir_et_regler_votre_chauffage__modifier_votre_maniere_de_conduire_ou_renoncer_a_prendre_votre_vehicule_pour_de_tres_petites_distances__",
												(row2.Qu_est_ce_qui_pourrait_vous_inciter_a_changer_vos_comportements_comme_par_exemple_mieux_entretenir_et_regler_votre_chauffage__modifier_votre_maniere_de_conduire_ou_renoncer_a_prendre_votre_vehicule_pour_de_tres_petites_distances__ != null
														? row2.Qu_est_ce_qui_pourrait_vous_inciter_a_changer_vos_comportements_comme_par_exemple_mieux_entretenir_et_regler_votre_chauffage__modifier_votre_maniere_de_conduire_ou_renoncer_a_prendre_votre_vehicule_pour_de_tres_petites_distances__
																.toString()
														: null));
										arraysValueMap_tWriteJSONField_1_Out.put(
										...
										valueMap_tWriteJSONField_1_Out.put(
												"Quelles_seraient_pour_vous_les_solutions_les_plus_simples_et_les_plus_supportables_sur_un_plan_financier_pour_vous_inciter_a_changer_vos_comportements__",
												(row2.Quelles_seraient_pour_vous_les_solutions_les_plus_simples_et_les_plus_supportables_sur_un_plan_financier_pour_vous_inciter_a_changer_vos_comportements__ != null
														? row2.Quelles_seraient_pour_vous_les_solutions_les_plus_simples_et_les_plus_supportables_sur_un_plan_financier_pour_vous_inciter_a_changer_vos_comportements__
																.toString()
														: null));
										arraysValueMap_tWriteJSONField_1_Out.put(
										...
										valueMap_tWriteJSONField_1_Out.put(
												"Par_rapport_a_votre_mode_de_chauffage_actuel__pensez_vous_qu_il_existe_des_solutions_alternatives_plus_ecologiques__",
												(row2.Par_rapport_a_votre_mode_de_chauffage_actuel__pensez_vous_qu_il_existe_des_solutions_alternatives_plus_ecologiques__ != null
														? row2.Par_rapport_a_votre_mode_de_chauffage_actuel__pensez_vous_qu_il_existe_des_solutions_alternatives_plus_ecologiques__
																.toString()
														: null));
										arraysValueMap_tWriteJSONField_1_Out.put(
										...
										valueMap_tWriteJSONField_1_Out.put(
												"Si_oui__que_faudrait_il_faire_pour_vous_convaincre_ou_vous_aider_a_changer_de_mode_de_chauffage__",
												(row2.Si_oui__que_faudrait_il_faire_pour_vous_convaincre_ou_vous_aider_a_changer_de_mode_de_chauffage__ != null
														? row2.Si_oui__que_faudrait_il_faire_pour_vous_convaincre_ou_vous_aider_a_changer_de_mode_de_chauffage__
																.toString()
														: null));
										arraysValueMap_tWriteJSONField_1_Out.put(
										...
										valueMap_tWriteJSONField_1_Out.put(
												"Avez_vous_pour_vos_deplacements_quotidiens_la_possibilite_de_recourir_a_des_solutions_de_mobilite_alternatives_a_la_voiture_individuelle_comme_les_transports_en_commun__le_covoiturage__l_auto_partage__le_transport_a_la_demande__le_velo__etc___",
												(row2.Avez_vous_pour_vos_deplacements_quotidiens_la_possibilite_de_recourir_a_des_solutions_de_mobilite_alternatives_a_la_voiture_individuelle_comme_les_transports_en_commun__le_covoiturage__l_auto_partage__le_transport_a_la_demande__le_velo__etc___ != null
														? row2.Avez_vous_pour_vos_deplacements_quotidiens_la_possibilite_de_recourir_a_des_solutions_de_mobilite_alternatives_a_la_voiture_individuelle_comme_les_transports_en_commun__le_covoiturage__l_auto_partage__le_transport_a_la_demande__le_velo__etc___
																.toString()
														: null));
										arraysValueMap_tWriteJSONField_1_Out.put(
										...
										valueMap_tWriteJSONField_1_Out.put(
												"Si_oui__que_faudrait_il_faire_pour_vous_convaincre_ou_vous_aider_a_utiliser_ces_solutions_alternatives__",
												(row2.Si_oui__que_faudrait_il_faire_pour_vous_convaincre_ou_vous_aider_a_utiliser_ces_solutions_alternatives__ != null
														? row2.Si_oui__que_faudrait_il_faire_pour_vous_convaincre_ou_vous_aider_a_utiliser_ces_solutions_alternatives__
																.toString()
														: null));
										arraysValueMap_tWriteJSONField_1_Out.put(
										...
										valueMap_tWriteJSONField_1_Out.put(
												"Si_non__quelles_sont_les_solutions_de_mobilite_alternatives_que_vous_souhaiteriez_pouvoir_utiliser__",
												(row2.Si_non__quelles_sont_les_solutions_de_mobilite_alternatives_que_vous_souhaiteriez_pouvoir_utiliser__ != null
														? row2.Si_non__quelles_sont_les_solutions_de_mobilite_alternatives_que_vous_souhaiteriez_pouvoir_utiliser__
																.toString()
														: null));
										arraysValueMap_tWriteJSONField_1_Out.put(
										...
										valueMap_tWriteJSONField_1_Out.put(
												"Et_qui_doit_selon_vous_se_charger_de_vous_proposer_ce_type_de_solutions_alternatives__",
												(row2.Et_qui_doit_selon_vous_se_charger_de_vous_proposer_ce_type_de_solutions_alternatives__ != null
														? row2.Et_qui_doit_selon_vous_se_charger_de_vous_proposer_ce_type_de_solutions_alternatives__
																.toString()
														: null));
										arraysValueMap_tWriteJSONField_1_Out.put(
										...
										valueMap_tWriteJSONField_1_Out.put(
												"Que_pourrait_faire_la_France_pour_faire_partager_ses_choix_en_matiere_d_environnement_au_niveau_europeen_et_international__",
												(row2.Que_pourrait_faire_la_France_pour_faire_partager_ses_choix_en_matiere_d_environnement_au_niveau_europeen_et_international__ != null
														? row2.Que_pourrait_faire_la_France_pour_faire_partager_ses_choix_en_matiere_d_environnement_au_niveau_europeen_et_international__
																.toString()
														: null));
										arraysValueMap_tWriteJSONField_1_Out.put(
										...
										valueMap_tWriteJSONField_1_Out.put(
												"Y_a_t_il_d_autres_points_sur_la_transition_ecologique_sur_lesquels_vous_souhaiteriez_vous_exprimer__",
												(row2.Y_a_t_il_d_autres_points_sur_la_transition_ecologique_sur_lesquels_vous_souhaiteriez_vous_exprimer__ != null
														? row2.Y_a_t_il_d_autres_points_sur_la_transition_ecologique_sur_lesquels_vous_souhaiteriez_vous_exprimer__
																.toString()
														: null));
										arraysValueMap_tWriteJSONField_1_Out.put(
										...
										strTemp_tWriteJSONField_1_Out = strTemp_tWriteJSONField_1_Out
												...
												+ valueMap_tWriteJSONField_1_Out.get("reference").length();
										if (strCompCache_tWriteJSONField_1_Out == null) {
											strCompCache_tWriteJSONField_1_Out = strTemp_tWriteJSONField_1_Out;

											rowStructOutput_tWriteJSONField_1_Out.reference = row2.reference;
											...
											if (!strCompCache_tWriteJSONField_1_Out
												...
												row_tWriteJSONField_1_Out.id = rowStructOutput_tWriteJSONField_1_Out.reference;

												row_tWriteJSONField_1_Out.json = strWriter_tWriteJSONField_1_Out
														.toString();
										...
										if (needRoot_tWriteJSONField_1_Out) {
											...
											org.dom4j.Element root_0_tWriteJSONField_1_Out = root_tWriteJSONField_1_Out
													.addElement("theme");
											if (valueMap_tWriteJSONField_1_Out.get("theme") != null) {
											...
											org.dom4j.Element root_9_tWriteJSONField_1_Out = root_tWriteJSONField_1_Out
											...
											org.dom4j.Element root_10_tWriteJSONField_1_Out = root_tWriteJSONField_1_Out
											...
											org.dom4j.Element root_11_tWriteJSONField_1_Out = root_tWriteJSONField_1_Out
													.addElement(
															"Quel_est_aujourd_hui_pour_vous_le_probleme_concret_le_plus_important_dans_le_domaine_de_l_environnement__");
											...
											org.dom4j.Element root_12_tWriteJSONField_1_Out = root_tWriteJSONField_1_Out
													.addElement(
															"Que_faudrait_il_faire_selon_vous_pour_apporter_des_reponses_a_ce_probleme__");
											if (valueMap_tWriteJSONField_1_Out.get(
											...
											org.dom4j.Element root_13_tWriteJSONField_1_Out = root_tWriteJSONField_1_Out
													.addElement(
															"Diriez_vous_que_votre_vie_quotidienne_est_aujourd_hui_touchee_par_le_changement_climatique__");
											if (valueMap_tWriteJSONField_1_Out.get(
											...
											org.dom4j.Element root_14_tWriteJSONField_1_Out = root_tWriteJSONField_1_Out
													.addElement(
															"Si_oui__de_quelle_maniere_votre_vie_quotidienne_est_elle_touchee_par_le_changement_climatique__");
											if (valueMap_tWriteJSONField_1_Out.get(
											...
											org.dom4j.Element root_15_tWriteJSONField_1_Out = root_tWriteJSONField_1_Out
													.addElement(
															"A_titre_personnel__pensez_vous_pouvoir_contribuer_a_proteger_l_environnement__");
											if (valueMap_tWriteJSONField_1_Out.get(
											...
											org.dom4j.Element root_16_tWriteJSONField_1_Out = root_tWriteJSONField_1_Out
													.addElement(
															"Si_oui__que_faites_vous_aujourd_hui_pour_proteger_l_environnement_et_ou_que_pourriez_vous_faire__");
											if (valueMap_tWriteJSONField_1_Out.get(
											...
											org.dom4j.Element root_17_tWriteJSONField_1_Out = root_tWriteJSONField_1_Out
													.addElement(
															"Qu_est_ce_qui_pourrait_vous_inciter_a_changer_vos_comportements_comme_par_exemple_mieux_entretenir_et_regler_votre_chauffage__modifier_votre_maniere_de_conduire_ou_renoncer_a_prendre_votre_vehicule_pour_de_tres_petites_distances__");
											if (valueMap_tWriteJSONField_1_Out.get(
											...
											org.dom4j.Element root_18_tWriteJSONField_1_Out = root_tWriteJSONField_1_Out
													.addElement(
															"Quelles_seraient_pour_vous_les_solutions_les_plus_simples_et_les_plus_supportables_sur_un_plan_financier_pour_vous_inciter_a_changer_vos_comportements__");
											if (valueMap_tWriteJSONField_1_Out.get(
											...
											org.dom4j.Element root_19_tWriteJSONField_1_Out = root_tWriteJSONField_1_Out
													.addElement(
															"Par_rapport_a_votre_mode_de_chauffage_actuel__pensez_vous_qu_il_existe_des_solutions_alternatives_plus_ecologiques__");
											if (valueMap_tWriteJSONField_1_Out.get(
											...
											org.dom4j.Element root_20_tWriteJSONField_1_Out = root_tWriteJSONField_1_Out
													.addElement(
															"Si_oui__que_faudrait_il_faire_pour_vous_convaincre_ou_vous_aider_a_changer_de_mode_de_chauffage__");
											if (valueMap_tWriteJSONField_1_Out.get(
											...
											org.dom4j.Element root_21_tWriteJSONField_1_Out = root_tWriteJSONField_1_Out
													.addElement(
															"Avez_vous_pour_vos_deplacements_quotidiens_la_possibilite_de_recourir_a_des_solutions_de_mobilite_alternatives_a_la_voiture_individuelle_comme_les_transports_en_commun__le_covoiturage__l_auto_partage__le_transport_a_la_demande__le_velo__etc___");
											if (valueMap_tWriteJSONField_1_Out.get(
											...
											org.dom4j.Element root_22_tWriteJSONField_1_Out = root_tWriteJSONField_1_Out
													.addElement(
															"Si_oui__que_faudrait_il_faire_pour_vous_convaincre_ou_vous_aider_a_utiliser_ces_solutions_alternatives__");
											if (valueMap_tWriteJSONField_1_Out.get(
											...
											org.dom4j.Element root_23_tWriteJSONField_1_Out = root_tWriteJSONField_1_Out
													.addElement(
															"Si_non__quelles_sont_les_solutions_de_mobilite_alternatives_que_vous_souhaiteriez_pouvoir_utiliser__");
											if (valueMap_tWriteJSONField_1_Out.get(
											...
											org.dom4j.Element root_24_tWriteJSONField_1_Out = root_tWriteJSONField_1_Out
													.addElement(
															"Et_qui_doit_selon_vous_se_charger_de_vous_proposer_ce_type_de_solutions_alternatives__");
											if (valueMap_tWriteJSONField_1_Out.get(
											...
											org.dom4j.Element root_25_tWriteJSONField_1_Out = root_tWriteJSONField_1_Out
													.addElement(
															"Que_pourrait_faire_la_France_pour_faire_partager_ses_choix_en_matiere_d_environnement_au_niveau_europeen_et_international__");
											if (valueMap_tWriteJSONField_1_Out.get(
											...
											org.dom4j.Element root_26_tWriteJSONField_1_Out = root_tWriteJSONField_1_Out
													.addElement(
															"Y_a_t_il_d_autres_points_sur_la_transition_ecologique_sur_lesquels_vous_souhaiteriez_vous_exprimer__");
											if (valueMap_tWriteJSONField_1_Out.get(
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				RestHighLevelClient client = new RestHighLevelClient(RestClient
						.builder(new HttpHost(context.elasticsearch_host, context.elasticsearch_port, "http")));
				Logger logger = LogManager.getLogger("Loader");
				...
				while (!globalMap.containsKey(readFinishMarkWithPipeId_tWriteJSONField_1_In)
					...
					if (!queue_tWriteJSONField_1_In.isEmpty()) {
						...
						IndexRequest one = new IndexRequest(context.indice).id(row3.name + row3.id)
								.source(row3.json.replace("[]", "\"\""), XContentType.JSON);
	...
	public static void main(String[] args) {
		final kafka2elasticsearch kafka2elasticsearchClass = new kafka2elasticsearch();

		int exitCode = kafka2elasticsearchClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = kafka2elasticsearch.class.getClassLoader().getResourceAsStream(
					"debat_national/kafka2elasticsearch_1_0/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = kafka2elasticsearch.class.getClassLoader()
			...
			class ContextProcessing {
				private void processContext_0() {
					...
					context.setContextType("elasticsearch_port", "id_Integer");
					try {
						context.elasticsearch_port = routines.system.ParserUtils
								.parseTo_Integer(context.getProperty("elasticsearch_port"));
					} catch (NumberFormatException e) {
						System.err.println(String.format("Null value will be used for context parameter %s: %s",
								"elasticsearch_port", e.getMessage()));
						context.elasticsearch_port = null;
					}
					context.setContextType("group_cassandra", "id_String");
					context.group_cassandra = (String) context.getProperty("group_cassandra");
					context.setContextType("group_elasticsearch", "id_String");
					context.group_elasticsearch = (String) context.getProperty("group_elasticsearch");
					context.setContextType("indice", "id_String");
					context.indice = (String) context.getProperty("indice");
		...
		if (parentContextMap != null && !parentContextMap.isEmpty()) {
			...
			if (parentContextMap.containsKey("elasticsearch_port")) {
				context.elasticsearch_port = (Integer) parentContextMap.get("elasticsearch_port");
			}
			if (parentContextMap.containsKey("group_cassandra")) {
				context.group_cassandra = (String) parentContextMap.get("group_cassandra");
			}
			if (parentContextMap.containsKey("group_elasticsearch")) {
				context.group_elasticsearch = (String) parentContextMap.get("group_elasticsearch");
			}
			if (parentContextMap.containsKey("indice")) {
				context.indice = (String) parentContextMap.get("indice");
			}
		...
		if (false) {
			System.out.println(
					(endUsedMemory - startUsedMemory) + " bytes memory increase when running : kafka2elasticsearch");
		}
...
/************************************************************************************************
 * 174964 characters generated by Talend Open Studio for Big Data on the
 * September 10, 2019 at 12:12:56 PM UTC
 ************************************************************************************************/